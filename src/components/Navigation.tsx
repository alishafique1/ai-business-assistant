...
export default function Navigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50 shadow-lg transition-transform duration-300 ease-in-out ${
