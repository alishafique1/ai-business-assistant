      ...
      return (
        ...
        >
          <span className="relative z-10 flex items-center justify-center w-full transition-all duration-300">
            ...
            <div className="absolute left-full top-1/2 -translate-y-1/2 flex transition-all duration-300 opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-4 ml-3">
